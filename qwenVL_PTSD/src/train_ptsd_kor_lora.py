#!/usr/bin/env python3
"""Text-only LoRA SFT for Qwen3-VL on Korean PTSD counseling data."""
...
def print_batch_summary(args: argparse.Namespace, dataset_size: int, world_size: int) -> None:
    ...
    if not is_main_process():
        return
    print("==== PTSD Qwen3-VL Text-only LoRA Training ====", flush=True)
...
def main() -> None:
    ...
    train_dataset = PtsdQwenDataset(args.data_path)
