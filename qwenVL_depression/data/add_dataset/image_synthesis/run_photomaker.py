...
try:
    ...
    raise SystemExit(
        "PhotoMaker generation requires diffusers. Install it in the active environment first, "
        "then rerun this script."
    ) from exc

MIRROR_CODE_DIR = Path("/home/jihyunlee/mirror/MIRROR_code")
if str(MIRROR_CODE_DIR) not in sys.path:
    sys.path.insert(0, str(MIRROR_CODE_DIR))
...
if __name__=="__main__":
    ...
    parser.add_argument("--prompt_path", type=str, default=str(ROOT_DIR / "data/add_dataset/image_synthesis/photomaker_prompts/prompt.jsonl"))
    parser.add_argument("--save_dir", type=str, default=str(ROOT_DIR / "data/mirror_images"))
